                ...
                <form action="{{ route('surat_keluar.store') }}" method="post">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text"
                                class="form-control form-control-sm @error('sk_nomor')
                                    is-invalid
                                @enderror"
                                id="sk_nomor" placeholder="Masukan Nomor Surat ex: 001" value="{{ old('sk_nomor') }}"
                                name="sk_nomor">
                            @error('sk_nomor')
                        ...
                        <div class="col-6">
                            ...
                            <input type="text"
                                class="form-control form-control-sm @error('sk_lampiran')
                                    is-invalid
                                @enderror"
                                id="sk_lampiran" placeholder="Masukan Lampiran" value="{{ old('sk_lampiran') }}"
                                name="sk_lampiran">
                            @error('sk_lampiran')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text"
                                class="form-control form-control-sm @error('sk_perihal')
                                    is-invalid
                                @enderror"
                                id="sk_perihal" placeholder="Masukan Perihal" value="{{ old('sk_perihal') }}"
                                name="sk_perihal">
                            @error('sk_perihal')
                                <div class="invalid-feedback">
                    ...
                    <div class="form-group row mt-3">
                        <div class="col-6">
                            ...
                            <input type="text"
                                class="form-control form-control-sm @error('sk_tujuan')
                                    is-invalid
                                @enderror"
                                id="sk_tujuan" placeholder="Masukan Tujuan ex: Nanda" value="{{ old('sk_tujuan') }}"
                                name="sk_tujuan">
                            @error('sk_tujuan')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('sk_tempat') }}" name="sk_tempat">
                            @error('sk_tempat')
                                <div class="invalid-feedback">
                    ...
                    <div class="form-group row mt-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sk_deskripsi" id="sk_deskripsi" cols="50" rows="10">{{ old('sk_deskripsi') }}</textarea>
                            @error('sk_deskripsi')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sk_tembusan" id="sk_tembusan" cols="50" rows="10">{{ old('sk_tembusan') }}</textarea>
                            @error('sk_tembusan')
                                <div class="invalid-feedback">
