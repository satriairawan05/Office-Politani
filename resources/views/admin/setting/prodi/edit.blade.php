                    ...
                    <div class="form-group row mt-3">
                        <div class="col-6">
                            ...
                            <input type="text"
                                class="form-control form-control-sm @error('prodi_name')
                                    is-invalid
                                @enderror"
                                id="prodi_name" placeholder="Masukan Nama"
                                value="{{ old('prodi_name', $prodi->prodi_name) }}" name="prodi_name" required>
                            @error('prodi_name')
                        ...
                        <div class="col-6">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('prodi_jenjang', $prodi->prodi_jenjang) }}" name="prodi_jenjang" required>
                            @error('prodi_jenjang')
                                <div class="invalid-feedback">
